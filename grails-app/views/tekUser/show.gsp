		...
		<div id="show-tekUser" class="content scaffold-show" role="main">
				...
				<g:if test="${tekUserInstance?.fullName}">
		    		<li class="fieldcontain">
				        ...
				        <span class="property-value" aria-labelledby="fullName-label">
                            <g:fieldValue bean="${tekUserInstance}" field="fullName"/>
                        </span>
				    </li>
				</g:if>
				...
				<g:if test="${tekUserInstance?.userName}">
				    <li class="fieldcontain">
		    			...
		    			<span class="property-value" aria-labelledby="userName-label">
                            <g:fieldValue bean="${tekUserInstance}" field="userName"/>
                        </span>
				    </li>
				</g:if>
				...
				<g:if test="${tekUserInstance?.email}">
    				<li class="fieldcontain">
						...
						<span class="property-value" aria-labelledby="email-label">
                            <g:fieldValue bean="${tekUserInstance}" field="email"/>
                        </span>
				    </li>
				</g:if>
				...
				<g:if test="${tekUserInstance?.website}">
				    <li class="fieldcontain">
						...
						<span class="property-value" aria-labelledby="website-label">
                            <g:fieldValue bean="${tekUserInstance}" field="website"/>
                        </span>
				    </li>
				</g:if>
				...
				<g:if test="${tekUserInstance?.bio}">
				    <li class="fieldcontain">
						...
						<span class="property-value" aria-labelledby="bio-label">
                            <g:fieldValue bean="${tekUserInstance}" field="bio"/>
                        </span>
				    </li>
				</g:if>
				...
				<g:if test="${tekUserInstance?.password}">
				    <li class="fieldcontain">
						...
						<span class="property-value" aria-labelledby="password-label">
                            <g:fieldValue bean="${tekUserInstance}" field="password"/>
                        </span>
				    </li>
				</g:if>
			...
			<g:form>
				<fieldset class="buttons">
					...
					<g:link class="edit" action="edit" id="${tekUserInstance?.id}">
