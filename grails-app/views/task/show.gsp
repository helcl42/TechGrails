...
<html>
	...
	<body>
		...
		<div id="show-task" class="content scaffold-show" role="main">
            <h1>${fieldValue(bean: taskInstance, field: 'title')}</h1>
			...
			<ol class="property-list task">
				...
				<g:if test="${taskInstance?.title}">
				    <li class="fieldcontain">
						...
						<span class="property-value" aria-labelledby="title-label">
                            <g:fieldValue bean="${taskInstance}" field="title"/>
                        </span>
				    </li>
				</g:if>
				...
				<g:if test="${taskInstance?.notes}">
				    <li class="fieldcontain">
						...
						<span class="property-value" aria-labelledby="notes-label">
                            <g:fieldValue bean="${taskInstance}" field="notes"/>
                        </span>
				    </li>
				</g:if>
				...
				<g:if test="${taskInstance?.assignedTo}">
				    <li class="fieldcontain">
						...
						<span class="property-value" aria-labelledby="assignedTo-label">
                            <g:link controller="tekUser" action="show" id="${taskInstance?.assignedTo?.id}">
				...
				<g:if test="${taskInstance?.event}">
				    <li class="fieldcontain">
						...
						<span class="property-value" aria-labelledby="event-label">
                            <g:link controller="tekEvent" action="show" id="${taskInstance?.event?.id}">
                ...
                <g:if test="${taskInstance.completed}">
                    <li class="fieldcontain">
                        ...
                        <span id="completed-value" class="property-value">
                            <g:fieldValue field="completed" bean="${taskInstance}" />
                        </span>
                    </li>
                </g:if>
			...
			<g:form>
				<fieldset class="buttons">
					...
					<g:link class="edit" action="edit" id="${taskInstance?.id}">
